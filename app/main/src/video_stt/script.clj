...
(comment
  (do (require '[dev])
      (def f (-> (dev/state) (::fn)))
      f)
  (f {:video "/Users/greg/OneDrive/Content/Courses/Inteligentny Inwestor (Edycja 2021)/3 Metale szlachetne/test/07_Jak_inwestowa_w_z_oto_10min.mp4"
      :output "/Users/greg/OneDrive/Content/Courses/Inteligentny Inwestor (Edycja 2021)/3 Metale szlachetne/test/07_Jak_inwestowa_w_z_oto_10min.txt"})
  )
